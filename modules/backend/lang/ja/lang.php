...
return [
    ...
    'account' => [
        ...
        'delete' => '削除',
        'ok' => 'OK',
        'signed_in_as' => 'ログイン名 :full_name',
        'id_pass_incorrect' => 'ユーザーIDまたはパスワードが間違っています。'
    ],
    'dashboard' => [
        'menu_label' => 'ダッシュボード',
        'widget_label' => 'ウィジェット',
    ...
    'user' => [
        ...
        'user_delete_confirm' => 'このユーザーを本当に削除しますか？',
        ...
        'role'  => [
            'menu_label' => 'ユーザー権限',
            'new'   => '新規作成',
            'delete_confirm' => '本当にこのユーザー権限を削除しますか？',
        ],
    ],
    'list' => [
        'default_title' => 'リスト',
    ...
    'fileupload' => [
        ...
        'remove_confirm' => 'アイキャッチ画像を削除しますか？'
    ],
    'form' => [
        'create_title' => "新規 :name",
        'update_title' => "編集 :name",
        'preview_title' => "プレビュー :name",
        'create_success' => ':nameが作成されました。',
        'update_success' => ':nameが更新されました。',
    ...
    'site-backup' => [
        ...
        'success' => 'Success',
        'error' => 'Error',
        'setting_success' => '定期バックアップが設定されました。',
        'import_success' => 'データベースが復元されました。',
        'import_fail' => 'データが正しくありません。',
    ],
    'comment' => [
        'name' => 'コメント管理',
        'setting_comment' => 'コメント許可設定',
        'blacklist' => 'NGワード登録',
        'blacklist_fields' => [
            'phrase' => 'ワード',
            'status' => '無効',
    ...
    'menu' => [
        ...
        'name' => 'メニュー名',
        'create' => '新規メニュー',
        'return_list' => 'メニューリストへ戻る',
        'type' => 'メニュータイプ',
        'is_active' => 'メニューを反映する',
        'placeholder_name' => 'メニュー名をつけてください',
        'delete_confirm' => '削除していいですか？',
        'location_number' => '順番は、数字で入力してください。',
        'location_exist' => '順番は、重複で入力されています。再度入力してください。',
        'menu_list_required' => 'カテゴリ、タグ、固定ページのいずれを必ず指定してください。'
    ],
    'workflow' => [
        'title' => 'ワークフロー設定',
        'create' => '新規追加',
        'return_list' => 'ワークフローリストへ戻る',
        'name' => 'ルート名',
        'placeholder_name' => 'ルート名をつけてください',
        'approve_list_required' => '担当者のいずれを必ず指定してください。',
        'location_number' => '順番は、数字で入力してください。',
        'location_exist' => '順番は、重複で入力されています。再度入力してください。',
    ],
     'sitebar' => [
         ...
         'location' => '表示側',
         'description' => '説明',
         'placeholder_name' => 'タイトルをつけてください',
         'location_required' => '順番は、必ず指定してください。',
         'update_success' => 'サイドバーウィジェットの情報が更新されました。',
         'list_post_required' => '投稿は、必ず選択してください。',
         'limit_regex' => '記事表示件数は数字で５以下でなければなりません。',

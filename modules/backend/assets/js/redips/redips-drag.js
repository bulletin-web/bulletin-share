...
REDIPS.drag = (function () {
	...
	elementControl = function (evt) {
        ...
        var flag = false,
            ...
            regexNodrag = /\bredips-nodrag\b/i,
        	regexNodragAce1 = /\bace_gutter\b/i,
            regexNodragAce2 = /\bace_layer\b/i,
            regexNodragAce3 = /\bace_gutter-cell\b/i,
            regexNodragAce4 = /\bace_gutter-active-line\b/i,
            regexNodragAce5 = /\bace_scroller\b/i,
            regexNodragAce6 = /\bace_content\b/i,
            regexNodragAce7 = /\bace_print-margin\b/i,
            regexNodragAce8 = /\bace_active-line\b/i,
            regexNodragAce9 = /\bace_line_group\b/i,
            regexNodragAce10 = /\bace_line\b/i,
            regexNodragAce11 = /\bace_cursor\b/i;
        ...
        switch (srcName) {
            ...
            default:
                ...
                flag = regexNodrag.test(classes)
					|| regexNodragAce1.test(classes)
                    || regexNodragAce2.test(classes)
                    || regexNodragAce3.test(classes)
                    || regexNodragAce4.test(classes)
                    || regexNodragAce5.test(classes)
                    || regexNodragAce6.test(classes)
                    || regexNodragAce7.test(classes)
                    || regexNodragAce8.test(classes)
                    || regexNodragAce9.test(classes)
                    || regexNodragAce10.test(classes)
                    || regexNodragAce11.test(classes);
        }

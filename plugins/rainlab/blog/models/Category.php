...
class Category extends Model
{
     ...
     */
    public $rules = [
        'name' => 'required|between:1,64|unique:rainlab_blog_categories',
        'color' => 'required',
        'slug' => 'required|between:3,64|unique:rainlab_blog_categories|regex:/^[a-z0-9][-a-z0-9]*$/',
//        'code' => 'unique:rainlab_blog_categories',
    ];
    /*
     * Custom attribute name validate
     */
    ...
    public $hasMany = [
        'posts' => ['RainLab\Blog\Models\Post', 'key' => 'category_id'],
        'tags' => ['RainLab\Blog\Models\Tag', 'key' => 'category_id']
    ];
